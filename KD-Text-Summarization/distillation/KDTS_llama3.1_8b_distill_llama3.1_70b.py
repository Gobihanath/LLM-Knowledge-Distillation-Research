...
# student.save_pretrained("../distilled-models-saved/models/llama3.1-8b-distill-llama3.1-70b")
# tokenizer.save_pretrained("../distilled-models-saved/tokenizer/llama3.1-8b-distill-llama3.1-70b")
