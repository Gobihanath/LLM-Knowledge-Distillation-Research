...
teacher_model_path = "tiiuae/falcon-40b"
student_model_path = "tiiuae/falcon-7b"
...
with open("../summarized-datasets/teacher-summarized/falcon_40b_summarized_texts.txt", "r", encoding="utf-8") as f:
...
student.save_pretrained("../distilled-models-saved/falcon-7b-distill-falcon-40b")
tokenizer.save_pretrained("../distilled-models-saved/falcon-7b-distill-falcon-40b")
...
print("\n🔍 Evaluation Results-falcon-7b-distill-falcon-40b:")
