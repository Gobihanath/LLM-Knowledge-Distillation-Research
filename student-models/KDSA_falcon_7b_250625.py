...
output_data_path = "../output-datasets/SA_falcon_7b.csv"
...
print(" Loading falcon-7b model and tokenizer...")
tokenizer = AutoTokenizer.from_pretrained(model_id)
model = AutoModelForCausalLM.from_pretrained(model_id, device_map="auto", torch_dtype=torch.float16)

# Step 2: Define sentiment classification function
def classify_sentiment_falcon(text):
...
for i, text in enumerate(texts):
    pred = classify_sentiment_falcon(text)
