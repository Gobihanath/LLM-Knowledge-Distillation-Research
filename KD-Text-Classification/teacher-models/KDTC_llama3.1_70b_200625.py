...
input_csv = "../raw-dataset/data1.csv"
output_data_path = "../output-datasets/TC_llama3.1_70b.csv"
...
# Step 2: Define classification function (3 classes)
def classify_topic_llama(text):
...
for i, text in enumerate(texts):
    pred = classify_topic_llama(text)
