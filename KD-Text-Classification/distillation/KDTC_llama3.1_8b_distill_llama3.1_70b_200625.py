...
csv_path = "../raw-dataset/data1.csv"
save_model_path = "../distill-models-saved/llama3.1_8b_distill_llama3.1_70b"
output_csv_path = "../output-datasets/TC_llama3.1_8b_distill_llama3.1_70b.csv"
results_csv_path = "../results/results.csv"

num_labels = 3   #  Updated for 3 classes
batch_size = 16
num_epochs = 3
learning_rate = 2e-5
temperature = 2.0
...
def classify_prompt(text):
    prompt = f"""Classify the following sentence into one of the categories: Sports, Politics, or Entertainment.
...
Category:"""
    ...
    if "sports" in decoded:
        return 0
    elif "politics" in decoded:
        return 1
    elif "entertainment" in decoded:
        return 2
    else:
        return -1
...
metrics_entry = pd.DataFrame([{
    "model": "llama3.1_8b_distilled_llama3.1_70b",
    "accuracy": accuracy,
    "precision": precision,
    "recall": recall,
    "f1_score": f1,
