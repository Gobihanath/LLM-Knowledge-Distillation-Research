...
with open("../summarized-datasets/teacher-summarized/llama3.1_70b_summarized_texts.txt", "r", encoding="utf-8") as f:
...
student.save_pretrained("../distilled-models-saved/llama3.1-8b-distill-llama3.1-70b")
tokenizer.save_pretrained("../distilled-models-saved/llama3.1-8b-distill-llama3.1-70b")
...
print("\n🔍 Evaluation Results-llama3.1-8b-distill-llama3.1-70b:")
